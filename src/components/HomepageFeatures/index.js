...
const FeatureList = [
  {
    title: '这是什么？',
    Svg: require('@site/static/img/book-stack.svg').default,
    description: (
      <>
  ...
  {
    title: '怎么使用？',
    Svg: require('@site/static/img/search-guide.svg').default,
    description: (
      <>
  ...
  {
    title: '我也有资料想要贡献！',
    Svg: require('@site/static/img/upload-share.svg').default,
    description: (
      <>
